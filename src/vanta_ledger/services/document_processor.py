...
try:
    ...
    NLP_AVAILABLE = False
    logging.warning("spaCy model not available. Install: python -m spacy download en_core_web_sm")

class DocumentProcessor:
    """Advanced document processing with OCR, AI analysis, and information extraction"""
    
    def __init__(self, upload_dir: str = "../data/uploads", processed_dir: str = "../data/processed_documents"):
        ...
        self.document_patterns = {
            'invoice': [
                r'invoice', r'bill', r'payment', r'amount due', r'total amount',
                r'customer', r'client', r'account', r'balance'
            ],
            'contract': [
                r'contract', r'agreement', r'terms', r'conditions', r'parties',
                r'effective date', r'expiration', r'termination'
            ],
            'receipt': [
                r'receipt', r'purchase', r'item', r'quantity', r'price',
                r'cash', r'credit', r'debit', r'transaction'
            ],
            'report': [
                r'report', r'summary', r'analysis', r'findings', r'conclusion',
                r'recommendation', r'overview', r'status'
            ],
            'proposal': [
                r'proposal', r'quote', r'estimate', r'bid', r'offer',
                r'scope of work', r'project', r'cost'
            ]
        }
    ...
    def process_document(self, file_path: str, original_filename: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Store original file
            original_file_path = self._store_original_file(file_path, doc_id, original_filename)
    ...
    def _store_original_file(self, file_path: str, doc_id: str, original_filename: str) -> Path:
