...
from backend.app.models.document_models import (
    EnhancedDocument, DocumentTag, DocumentCategory, DocumentMetadata,
    DocumentType, DocumentStatus, DocumentPriority, DocumentSearchCriteria
)
    ...
    def test_list_documents_with_filters(self):
        ...
        with patch('backend.app.routes.enhanced_documents.get_current_user') as mock_user:
            ...
            with patch('backend.app.routes.enhanced_documents.enhanced_document_service') as mock_service:
                ...
                response = client.get("/api/v2/documents/", params={
                    "page": 1,
                    "limit": 10,
                    "document_type": "invoice",
                    "status": "processed",
    ...
    def test_create_category(self, sample_category_data):
        ...
        with patch('backend.app.routes.enhanced_documents.get_current_user') as mock_user:
            ...
            with patch('backend.app.routes.enhanced_documents.enhanced_document_service') as mock_service:
                ...
                response = client.post("/api/v2/documents/categories", json=sample_category_data)
    ...
    def test_get_search_suggestions(self):
        ...
        with patch('backend.app.routes.enhanced_documents.get_current_user') as mock_user:
            ...
            with patch('backend.app.routes.enhanced_documents.enhanced_document_service') as mock_service:
                ...
                response = client.get("/api/v2/documents/search/suggestions", params={
                    "query": "invoice"
                })
