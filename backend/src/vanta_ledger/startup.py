...
async def initialize_database():
    ...
    try:
        ...
        if success:
            ...
            # Initialize user service after database is ready
            try:
                from .database_init import DatabaseInitializer
                from .services.user_service import init_user_service
                
                # Create a database session and initialize the user service
                ...
                logger.info("Continuing startup without user service initialization")
        else:
