...
def main():
    ...
    try:
        ...
        logger.info("=")
        logger.info(f"✅ Successfully processed: {results[")
        logger.error(f"❌ Failed extractions: {results[")
        logger.info(f"📊 Success rate: {results[")
        logger.info(f"📈 Average confidence: {results[")
        logger.info("\n📊 Extraction Features:")
        logger.info("   - Amount extraction")
        logger.info("   - Date extraction")
        logger.info("   - Invoice number extraction")
        logger.info("   - Vendor name extraction")
        logger.info("   - Transaction classification")
        logger.info("   - Category classification")
